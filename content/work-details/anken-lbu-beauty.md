...
- 競合調査を通じた技術仕様の策定、IA設計、およびデザインデータの作成。
- ブランディングデザイン・PMFを主軸に構成案作成。
- リニューアルにおけるフロントエンド領域の全実装を担当。
- インタラクティブな表現（マウスエフェクト、パーティクルエフェクト）や、UX向上のためにスクロールをコントロールした設計。
...
- ブログシステムの構築（EmDash × Cloudflare）
- ブランディングデザイン・PMFを主軸に構成案作成。
- リニューアルにおけるフロントエンド領域の全実装を担当。SPA～SSRへの移行。
- インタラクティブな表現（マウスエフェクト、パーティクルエフェクト）や、UX向上のためにスクロールをコントロールした設計。
- スケーラビリティを考慮したサーバーレス環境の設計・構築。
